        ...
        <div class="row min-vh-100 align-content-between">
                ...
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-md-6">
                        <div class="text-center text-md-left px-4 mb-4 mb-md-0">
                            <a href="#"><img src="/prime/images/logo.png" alt="logo" data-width="146px" data-height="42px" style="width: 146px; height: 42px;"></a>
                        </div>
                    </div>
            ...
            <div class="col-12 pt-md-3">
                <div class="text-center text-white-75 p-4 mt-md-1">
                    <small>Copyright @ <a href="{{route('home')}}" class="text-light font-weight-600">{{site('name')}}</a>. All Rights Reserved.</small>
                </div>
            </div>
