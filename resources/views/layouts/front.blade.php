...
_smartsupp.key = 'cacd4ac8cf4ad99dc1ce593c2f09c37dfd8439c4';
...
<body data-new-gr-c-s-check-loaded="14.1157.0" data-gr-ext-installed=""
    style="margin-top: 0px; position: relative; min-height: 100%; top: 0px;">
    ...
    <div class="navik-header header-shadow navik-mega-menu mega-menu-fullwidth viewport-sm" style="margin-top: 0px;">
        <div class="container">
            <div class="navik-header-container">
                ...
                <!--Logo-->
                <div class="logo" data-mobile-logo="/prime/images/logo.png" data-sticky-logo="/prime/images/logo.png">
                    <a href="{{route('home')}}"><img src="/prime/images/logo.png" alt="logo"></a>
                </div>
                ...
                <nav class="navik-menu menu-hover-3 menu-caret submenu-top-border">
                    <ul>
                        ...
                        <li><a href="{{route('pricing')}}">Investment Plans</a></li>
 ...
 <!-- Footer -->
                    ...
                    <div class="row py-5">
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            ...
                            <div class="widget">
                                ...
                                <img class="img-fluid d-block mb-4" src="/prime/images/logo1.png" alt="logo" data-width="146px"
                                    data-height="42px" style="width: 146px; height: 42px;">
                                ...
                                <p>We aim to deliver a strong and consistent investment performance, using the Ligrace
                                    Invest platform to identify the best opportunities.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12">
                                    ...
                                    <div class="widget">
                                        ...
                                        <form class="form-light-1"><input type="hidden" name="form_id"
                                                value="17097210717732"><input type="hidden" name="form_token"
                                                value="b82b41c8c7417a3dcfa9d8188619128d">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-5 mb-lg-0">
                                    ...
                                    <div class="widget">
                                        ...
                                        <h6 class="widget-title text-white text-uppercase font-weight-700">Useful Links
                                        </h6>
                                        ...
                                        <ul class="custom-list fa-ul mb-0 ml-4">
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                        aria-hidden="true"></i></span>

                                                <a href="{{route('home')}}" class="text-white-50 text-hover-primary">Home</a>
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('about')}}" class="text-white-50 text-hover-primary">About</a>
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('faqs')}}" class="text-white-50 text-hover-primary">Faq</a>
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('pricing')}}" class="text-white-50 text-hover-primary">Plans</a>
                                ...
                                <div class="col-md-6 mb-5 mb-lg-0">
                                    ...
                                    <div class="widget">
                                        ...
                                        <h6 class="widget-title text-white text-uppercase font-weight-700">Our Support
                                        </h6>
                                        ...
                                        <ul class="custom-list fa-ul mb-0 ml-4">
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('user.login')}}" class="text-white-50 text-hover-primary">Log In</a>
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('user.register')}}" class="text-white-50 text-hover-primary">Sign Up</a>
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('tos')}}" class="text-white-50 text-hover-primary">Term</a>
                                            ...
                                            <li><span class="fa-li"><i class="fas fa-angle-right text-primary"
                                                ...
                                                <a href="{{route('contact')}}"
                                                    class="text-white-50 text-hover-primary">Support</a>
                ...
                <div class="container footer-bottom-container">
                    ...
                    <div class="row py-3">
                        ...
                        <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                            ...
                            <small>Copyright @ <a href="#">Ligrace Holdings</a>. All Rights Reserved.</small>
                        ...
                        <div class="col-lg-6 text-center text-lg-right">
                            ...
                            <a href="{{ route('tos') }}" class="text-white-50 text-hover-primary mr-4">Terms</a>

                            <a href="{{ route('tos') }}" class="text-white-50 text-hover-primary">Privacy Policy</a>
        ...
        <div class="go-to-top">
            ...
            <a href="#" class="rounded-circle"><i class="fas fa-chevron-up" aria-hidden="true"></i></a>
